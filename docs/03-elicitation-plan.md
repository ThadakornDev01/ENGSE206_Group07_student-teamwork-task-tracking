...
|---|---|---|---|---|---|---|
| EO-01 | อาจารย์ผู้สอน |Semi-structured Interview: เพื่อให้ได้ความต้องการเชิงลึกเกี่ยวกับการประเมินผล โดยยังเปิดโอกาสให้อาจารย์เสนอความต้องการเพิ่มเติม |สรุปประเด็นสัมภาษณ์ (Interview Notes) และชุดข้อมูลที่ต้องการบน Dashboard | คมสันต์ (15 นาที) | อาจารย์มีเวลาจำกัด / แจ้งกรอบเวลาชัดเจนและเตรียมคำถามให้กระชับ | ได้ความต้องการข้อมูล (Data point) สำหรับทำ Dashboard |
